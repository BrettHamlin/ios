...
struct Dashboard: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 10) {
            ...
            CategoryChipRow(issues: store.state.issues, selectedCategory: $selectedCategory)
        ...
        .onChange(of: store.state.issues) {
            ...
            let updatedCategory = DashboardIssueQuery.selectedCategoryAfterRefresh(selectedCategory, issues: store.state.issues)
            if updatedCategory != selectedCategory {
...
struct IssuesList: View {
    ...
    private var query: DashboardIssueQuery {
        DashboardIssueQuery(
            searchText: searchText,
            showAllIssues: showAllIssues,
            selectedCategory: selectedCategory,
            allIssues: store.state.issues
        )
    }
