...
struct Dashboard: View {
    ...
    var categoryOptions: [Category] {
        IssueCategoryFilter.categoryOptions(from: store.state.issues)
    }
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 10) {
            ...
            CategoryFilterView(categories: categoryOptions, selectedCategory: $selectedCategory)
        ...
        .onChange(of: store.state.issues) {
            ...
            IssueCategoryFilter.validateSelectedCategory(&selectedCategory, for: store.state.issues)
        }
    }
}
...
struct IssuesList: View {
    ...
    var allIssues: [Issue] {
        IssueCategoryFilter.filteredIssues(
